    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 8:
          _context.prev = 8;
          _context.t0 = _context["catch"](0);
          (0, _alerts.showAlert)("error", "Error submitting data");
        case 11:
        case "end":
          return _context.stop();
      }
...
var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe("pk_test_51NpD5FSBtYTc4ZvIBtqzrk5s8mjtpjWzk5si0mOeRwY1DoBRMqipO2JO8wmhxidlyHu6sp8n4BlEhPdcLsyZBKd900EDkCsvqf");
          _context.prev = 1;
          _context.next = 4;
          return (0, _axios.default)({
            method: 'POST',
            url: "http://localhost:3000/api/v1/booking/checkout-session/".concat(tourId)
          });
        case 4:
